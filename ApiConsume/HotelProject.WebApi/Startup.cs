...
using HotelProject.BusinessLayer.Concerte;
...
namespace HotelProject.WebApi
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddScoped<IMessageCategoryService, MessageCategoryManeger>();
           ...
           // services.AddScoped
            ...
            // cors yapýlandýrýlmasý.  baþlýklara metodlara izin ver
            ...
            services.AddControllers().AddNewtonsoftJson(optipns =>
            optipns.SerializerSettings.ReferenceLoopHandling = Newtonsoft.Json.ReferenceLoopHandling.Ignore);
