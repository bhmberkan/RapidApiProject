        ...
        public async Task<IActionResult> Index(string cityID)
        {
            if (!string.IsNullOrEmpty(cityID))
            {
                ...
                var request = new HttpRequestMessage
                {
                    ...
                    RequestUri = new Uri($"https://booking-com.p.rapidapi.com/v2/hotels/search?dest_id=-{cityID}&order_by=popularity&checkout_date=2025-03-29&children_number=2&filter_by_currency=TRY&locale=en-gb&dest_type=city&checkin_date=2025-03-23&categories_filter_ids=class%3A%3A2%2Cclass%3A%3A4%2Cfree_cancellation%3A%3A1&children_ages=5%2C0&include_adjacency=true&page_number=0&adults_number=2&room_number=1&units=metric"),
                    Headers =
    {
